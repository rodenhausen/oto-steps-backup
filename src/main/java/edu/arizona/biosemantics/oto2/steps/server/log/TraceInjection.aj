package edu.arizona.biosemantics.oto2.steps.server.log;
...
public class TraceInjection {
	...
	@Before("within(edu.arizona.biosemantics.oto2.steps.server..*) && "
			+ "!within(edu.arizona.biosemantics.oto2.steps.server.log..*) && "
			+ "!within(edu.arizona.biosemantics.oto2.steps.server.db.Query) && "
			+ "execution(public * *(..))")
